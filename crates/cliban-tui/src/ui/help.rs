...
const SECTIONS: &[(&str, &[(&str, &str)])] = &[
    ...
    (
        ...
        &[
            ("Enter", "open detail"),
            ("H/L", "move issue across columns"),
            ("J/K", "reorder issue in column"),
            ("e", "edit issue ($EDITOR)"),
    ...
    (
        ...
        &[
            ...
            ("Ctrl-n/p", "move cursor (or arrows)"),
            ("G / PgDn", "bottom / half-page"),
            ("Enter", "scope board to milestone"),
            ("Tab / S-Tab", "open/completed/cancelled/all"),
