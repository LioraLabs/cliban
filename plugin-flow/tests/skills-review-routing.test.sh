...
# the bounce loop is bounded and re-reviews cannot widen it.
has "$milestone" 'Two bounced re-reviews'
has "$review" 'against the recorded findings'
has "$review" 'never bounce'
